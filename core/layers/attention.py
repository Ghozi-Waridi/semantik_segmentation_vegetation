...
class SpatialAttention:
    ...
    def backward(self, dout, learning_rate: float):
        ...
        dA = xp_module.sum(dout * self.input, axis=3, keepdims=True)  
        ...
        d_conv_weights = xp_module.zeros_like(self.conv_weights)  
        ...
        for i in range(h):
            for j in range(w):
                ...
                window = concat_padded[:, h_start:h_end, w_start:w_end, :]  
